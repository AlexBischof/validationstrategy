...
public class SoftAssertions {
  ...
  /**
   * Creates a new "soft" instance of <code>{@link MyPojoAssert}</code>.
   *
   * @param actual the actual value.
   * @return the created "soft" assertion object.
   */
  public MyPojoAssert assertThat(de.bischinger.validation.model.MyPojo actual) {
    return proxy(MyPojoAssert.class, de.bischinger.validation.model.MyPojo.class, actual);
  }
